...
var FoxUIDateTimePicker = function (showDate, showTime, current) {
    var self = this;
...
$.fn.timePicker = function (params,current) {
    var args = arguments;
    return this.each(function () {
        if (!this)
            return;
        ...
        if (!timePicker) {
            timePicker = new FoxUIDateTimePicker(false, true, current);
...
$.fn.relatePicker = function (params) {
    ...
    return this.each(function () {
        ...
        relatePicker.init(params, $(this).val());
...
$.fn.cityPicker = function (params) {
    ...
    return this.each(function () {
        ...
        cityPicker.params =$.extend(p, {
            columns: [{align: 'center', values: FoxUICityData,'css':'col-province'}]
        });
        ...
        cityPicker.init(cityPicker.params, $(this).val());
