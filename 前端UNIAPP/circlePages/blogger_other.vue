			...
			<view class="about__wrap">
				...
				<view class="meng">
								...
								<view class="tn-padding-right">
									<view class="tn-padding-right tn-padding-left-sm tn-text-xl tn-text-bold">
										...
										<block v-for="(item,indexdd) in body.medal_list" :key="indexdd" >
											<image :src="item.image" mode="heightFix" style="height: 30px;top: 10px;" @click="navigateToFn({ url: '/circlePages/medal?id='+id, checkLogin: false })">
					...
					<view class="tn-margin-left tn-text-sm tn-color-gray" style="margin-top: -25rpx;">
						<text class="tn-color-white tn-text-bold">{{body.dec}}</text>
					</view>
					...
					<view class="blogger-tips-data__info tn-flex">
							...
							<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
								<view class="">
									<view class="tn-text-xl tn-color-white">
										{{ $t.number.formatNumberAddPriceUnit(body.guanzhu) }}
									</view>
								</view>
								<view class="tn-margin-top-xs tn-color-gray tn-text-df tn-text-center">
									<text class="tn-padding-left-xs tn-color-white" style="font-size: 12px;">关注</text>
								</view>
							</view>
						</view>
						<view class="tn-flex-1 tn-padding-sm tn-margin-xs" @click="tofans('fans')">
							<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
								<view class="">
									<view class="tn-text-xl tn-color-white">
										{{ $t.number.formatNumberAddPriceUnit(body.fansi) }}
									</view>
								</view>
								<view class="tn-margin-top-xs tn-color-gray tn-text-df tn-text-center">

									<text class="tn-padding-left-xs tn-color-white" style="font-size: 12px;">粉丝</text>
								</view>
							</view>
						</view>
						<view class="tn-flex-1 tn-padding-sm tn-margin-xs">
							<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
								<view class="">
									<view class="tn-text-xl tn-color-white">
										{{ $t.number.formatNumberAddPriceUnit(body.zhan) }}
									</view>
								</view>
								<view class="tn-margin-top-xs tn-color-gray tn-text-df tn-text-center">
						...
						<view @click="guanzhu(id)"
							...
							<text v-if="body.is_follow"
								class="tn-bg-gray--light  tn-round tn-text-df tn-text-bold tn-color-black"
								style="padding: 10rpx 24rpx;">
								已关注</text>
							<text v-else class="tn-bg-yellow  tn-round tn-text-df tn-text-bold tn-color-black"
								style="padding: 10rpx 24rpx;">
								+ 关注</text>
