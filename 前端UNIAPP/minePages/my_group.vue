						...
						<view class="tn-margin-sm tn-padding-top-xs" style="width: 100%;" >
							...
							<view class="tn-flex tn-flex-row-between tn-flex-col-between">
								<view class="justify-content-item tn-color-gray tn-text-center tn-color-gray--disabled"
									...
									<text class="tn-icon-my tn-padding-right-xs tn-text-lg tn-color-orange"></text>
									<text class="tn-padding-right tn-text-df tn-color-orange">关注{{ item.follow_num }}</text>
									<text class="tn-icon-moments tn-padding-right-xs tn-text-lg tn-color-orange"></text>
									<text class="tn-text-df tn-color-orange">帖子{{ item.goods_num }}</text>
								</view>
							</view>
						</view>
					</view>
